...
# FIXED: Added init_boot for GKI device
AB_OTA_PARTITIONS += \
    boot \
    dtbo \
    init_boot \
...
# Kernel - Boot Header Version 4 (GKI)
BOARD_BOOT_HEADER_VERSION := 4
BOARD_BOOTIMG_HEADER_VERSION := $(BOARD_BOOT_HEADER_VERSION)
BOARD_KERNEL_BASE := 0x3fff8000
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 loglevel=4 arm64.nomte mtk_printk_ctrl.disable_uart=1 bootconfig
...
# FIXED: Removed --dtb for GKI boot image
...
# FIXED: DTB goes in vendor_boot for GKI, not boot
...
# ADDED: VBMETA size
BOARD_VBMETA_PARTITION_SIZE := 8388608
...
BOARD_MOTOROLA_DYNAMIC_PARTITIONS_SIZE := 7505804160

# File systems - FIXED to match device reality
